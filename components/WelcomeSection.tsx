  ...
  return (
    <div className="w-full max-w-4xl mx-auto px-4 py-8 space-y-8">
      ...
      <div className="text-center space-y-4 animate-in fade-in">
        <div className="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-[#57068C] shadow-lg mb-4">
          <Sparkles className="h-10 w-10 text-white" />
        </div>
        <h1 className="text-4xl md:text-5xl font-bold text-[#57068C] dark:text-purple-400 leading-normal">
      ...
      {/* How It Works */}
      <Card className="p-8 w-full bg-gradient-to-br from-purple-50/50 to-blue-50/50 dark:from-purple-950/20 dark:to-blue-950/20 border-purple-200 dark:border-purple-800">
        <h2 className="text-2xl font-bold mb-6 flex items-center gap-2 text-[#57068C] dark:text-purple-400">
          <Target className="h-6 w-6 text-[#57068C] dark:text-purple-400" />
          How It Works
        </h2>
      ...
      <div className="grid md:grid-cols-2 gap-4 w-full">
        <Card className="p-6 hover:shadow-lg transition-shadow border-purple-200 dark:border-purple-800">
          <div className="flex items-start gap-4">
            <div className="flex-shrink-0 w-12 h-12 rounded-lg bg-[#57068C] flex items-center justify-center">
      ...
      {/* CTA */}
      <div className="text-center pt-4 space-x-3 flex items-center justify-center w-full">
        <Button
          onClick={onGetStarted}
          size="lg"
          className="bg-[#57068C] hover:bg-[#6A0BA8] text-white shadow-lg px-8 py-6 text-lg"
        >
